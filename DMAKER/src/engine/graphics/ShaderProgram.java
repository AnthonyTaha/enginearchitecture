...
public class ShaderProgram {
	...
	public void setUniform(String uniformName, PointLight pointLight) {
		if(pointLight!=null) {
		    ...
		    setUniform(uniformName + ".position", pointLight.parent.getPosition());
	...
	public void SetUniform(String uniformName, Matrix4f val) {
		try(MemoryStack stack = MemoryStack.stackPush()){
			glUniformMatrix4fv(uniforms.get(uniformName), false, val.get(stack.mallocFloat(16)));
		}
	}
	...
	public void setUniform(String uniformName, DirectionalLight dirLight) {
	    ...
	    setUniform(uniformName + ".direction", dirLight.parent.getPosition());
	    setUniform(uniformName + ".intensity", dirLight.getIntensity());
		}
	}
	public void setUniform(String uniformName, List<PointLight> pointLights) throws Exception {
	...
	public void setUniform(String uniformName, PointLight pointLight, int pos) throws Exception {
